...
- Rewards balances and redemption goals
- Renewal dates and card-specific notes
...
The information stored on your device is used solely to provide the features of the App, including:

- Displaying your card benefits, usage progress, and renewal dates
- Tracking your rewards goals
- Generating spending insights and card recommendations based on your wallet
- Personalizing the App experience based on your settings and theme preferences

We do not use your information for marketing, advertising targeting, or any purpose beyond operating the App's features.
...
Because your data is stored locally on your device, it is protected by your device's built-in security features, including Face ID, Touch ID, and device encryption. We encourage you to use a strong passcode and keep your device's operating system up to date.

---

## Changes to This Policy

We may update this Privacy Policy from time to time. When we do, we will update the "Last Updated" date at the top of this page. Continued use of the App after any changes constitutes your acceptance of the updated policy. We encourage you to review this policy periodically.
...
*This privacy policy was last reviewed in March of 2026.*
